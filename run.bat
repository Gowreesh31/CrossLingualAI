@echo off
REM VideoTranslate AI - Run Script for Windows
REM This script sets up and runs the VideoTranslate AI application

echo 🚀 Starting VideoTranslate AI Application...
echo.
